...
class CSDNSpider():
    def __init__(self):
        #set link url
        self.url = 'https://blog.csdn.net/haojie_duan/category_11619472.html'
        self.headers = {
    ...
    def write_content(self, content, name):
        ...
        # 将html文件转换成PDF文件
        #wkhtmltox download link: https://wkhtmltopdf.org/downloads.html
        config = pdfkit.configuration(wkhtmltopdf=r'C:\programs\wkhtmltox\bin\wkhtmltopdf.exe')
